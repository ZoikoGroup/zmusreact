                  ...
                  <div className="card-body">
                    <div className="d-flex justify-content-between align-items-center">
                      <div>
                        ...
                        {/* <-- NEW: show formData details */}
          <div className="mt-2">
            {item.formData && Object.keys(item.formData).map((key) => (
              <p className="mb-0 small text-secondary" key={key}>
                {key}: {item.formData[key] || "N/A"}
              </p>
            ))}
          </div>
                      </div>
                    ...
                    <div className="d-flex align-items-center justify-content-between mt-3">
                      <span className="fw-bold">${item.planPrice} / {item.planDuration}</span>
                      <div>
