                ...
                <Container className="py-5">
                    <Row>
                        ...
                        <Col md={3} sm={12} xs={12}>
                            ...
                            <ul>
                                ...
                                <li>
                                    <Link href={"/california-consumer-privacy-act"}>
                    ...
                    <Row>
                        ...
                        <Col md={5} sm={12} xs={12}>
                            ...
                            <p>
                                Receive the latest offers, updates, and unlock amazing savings on Zoiko Mobile plans and devices.
                            </p>
                            ...
                            <Link href={"https://www.facebook.com/zoikomobileusa"} target="_blank">
                                <i className="bi bi-facebook"></i>
                            </Link>
                            <Link href={"https://instagram.com/zoikomobileus"} target="_blank" className="px-3">
                                <i className="bi bi-instagram"></i>
                            </Link>
                            <Link href={"https://uk.pinterest.com/zoikomobileusa/"} target="_blank">
                                <i className="bi bi-pinterest"></i>
                            </Link>
                            <Link href={"https://x.com/zoikomobileusa"} target="_blank" className="px-3">
                                <i className="bi bi-twitter-x"></i>
                            </Link>
                            <Link href={"https://www.linkedin.com/company/zoikomobileusa/"} target="_blank">
                                <i className="bi bi-linkedin"></i>
                            </Link>
                            <Link href={"https://www.threads.net/@zoikomobileus"} target="_blank" className="px-3">
                                <i className="bi bi-threads"></i>
                            </Link>
                            <Link href={"https://www.youtube.com/@ZoikoMobileUSA"} target="_blank">
