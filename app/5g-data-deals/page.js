...
export const metadata = {
  title: "5G Data Deals - Zoiko Mobile USA",
  description: "Get exponentially faster 5G mobile data plans with Zoiko Mobile's ultra-fast 5G network. 10X faster speeds, better connectivity, and super smooth performance.",
  keywords: "5G data plans, mobile data, fast internet, Zoiko Mobile, 5G network, mobile connectivity",
};
