...
const faqs = [
    ...
    },
    {
      ...
      a: "YES - Perfect holiday gift! All plans can be gifted this New Year.",
    },
  ];
  const offers = [
    {
...
<div className="text-center mb-4">
      ...
      <p className="text-muted refubrishedMobileSubHead">
        New Year refurbished phone deals USA - Up to 40% OFF
      </p>
</div>
      ...
      <Container>
        ...
        <Row className="text-center text-white">
          ...
          <Col md={3} className="mb-4">
            ...
            <p>New Year refurbished phone deals USA with 1-Year Warranty</p>
          </Col>
